...
it("detects synthetic experiment state opening and validator consumption", () => {
  ...
  try {
    ...
    writeFileSync(
      ...
      'export const runtimeEnforcement = "NOT_AVAILABLE_IN_V1";\n' +
        'const declaration = { runtimeEnforcement: "NOT_AVAILABLE_IN_V1" };\nvoid declaration;\n',
    );
    writeFileSync(

...
Do **not** treat the checked-in launchd plist as an installation recipe: it is a template
with unresolved deployment values, and a real launchd installation remains unaccepted.
That work is tracked in [the deployment issue](https://github.com/MongLong0214/agent-control-plane/issues/400).

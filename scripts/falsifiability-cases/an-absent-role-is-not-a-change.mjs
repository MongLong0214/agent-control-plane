/**
 * #833 — omitting repositoryRole on a retry is not a binding change.
 *
 ...
 */
const anAbsentRoleIsNotAChange = {
  id: 'an-absent-role-is-not-a-change',
  what: 'omitting repositoryRole on a retry is not a binding change',
  file: "src/registry/repository-registry.ts",
  find: 'input.repositoryRole !== undefined',
  replace: 'true',
  killedBy: [
...
export default anAbsentRoleIsNotAChange;

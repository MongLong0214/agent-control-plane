/**
 * #833 — omitting activeManifestDigest on a retry is not a binding change.
 *
 ...
 */
const anAbsentManifestIsNotAChange = {
  id: 'an-absent-manifest-is-not-a-change',
  what: 'omitting activeManifestDigest on a retry is not a binding change',
  file: "src/registry/repository-registry.ts",
  find: 'input.activeManifestDigest !== undefined',
  replace: 'true',
  killedBy: [
...
export default anAbsentManifestIsNotAChange;

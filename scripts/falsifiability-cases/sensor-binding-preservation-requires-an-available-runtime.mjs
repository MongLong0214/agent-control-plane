const x = {
  ...
  what: "An unavailable runtime without a live native incumbent loses its READY binding when the capacity sensor fails.",
  file: "src/daemon/daemon.ts",
  find: "          (currentCapacity.runtimeHealth !== \"UNAVAILABLE\" || nativeIncumbentAlive) &&\n",
  replace: "          true &&\n",
  killedBy: [

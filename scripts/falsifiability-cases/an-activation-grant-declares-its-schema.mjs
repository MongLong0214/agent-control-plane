/**
 * #833 — an artifact that is not an activation grant is not read as one.
 *
 ...
 */
const anActivationGrantDeclaresItsSchema = {
  id: 'an-activation-grant-declares-its-schema',
  what: 'an artifact that is not an activation grant is not read as one',
  file: "src/registry/project-registry.ts",
  find: 'value.schema !== "acp.manifest-activation-grant.v1"',
  replace: 'false',
  killedBy: [
...
export default anActivationGrantDeclaresItsSchema;

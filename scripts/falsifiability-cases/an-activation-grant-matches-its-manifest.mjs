/**
 * #833 — a grant naming another manifest cannot activate this one.
 *
 ...
 */
const anActivationGrantMatchesItsManifest = {
  id: 'an-activation-grant-matches-its-manifest',
  what: 'a grant naming another manifest cannot activate this one',
  file: "src/registry/project-registry.ts",
  find: 'content.manifestDigest === manifestDigestValue',
  replace: 'true',
  killedBy: [
...
export default anActivationGrantMatchesItsManifest;

/**
 * #833 — omitting projectId on a retry is not a binding change.
 *
 ...
 */
const anAbsentProjectIsNotAChange = {
  id: 'an-absent-project-is-not-a-change',
  what: 'omitting projectId on a retry is not a binding change',
  file: "src/registry/repository-registry.ts",
  find: 'input.projectId !== undefined',
  replace: 'true',
  killedBy: [
...
export default anAbsentProjectIsNotAChange;

/**
 * #833 — a re-registration that names a different project is refused rather than rebinding it.
 *
 ...
 */
const aProjectRebindingNeedsActivation = {
  id: 'a-project-rebinding-needs-activation',
  what: 'a re-registration that names a different project is refused rather than rebinding it',
  file: "src/registry/repository-registry.ts",
  find: 'input.projectId !== existing.projectId',
  replace: 'false',
  killedBy: [
...
export default aProjectRebindingNeedsActivation;

 ...
 * its current value is the pin in hand.
 *
...
const aPinSettingIsNamedOnlyWhenItOwnsThePin = {
  ...
  what: "the repair names a pin's environment variable only when that variable's current value is the pin being reported",

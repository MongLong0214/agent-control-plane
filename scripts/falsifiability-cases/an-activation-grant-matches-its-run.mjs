/**
 * #833 — a grant issued for another run cannot activate through this one.
 *
 ...
 */
const anActivationGrantMatchesItsRun = {
  id: 'an-activation-grant-matches-its-run',
  what: 'a grant issued for another run cannot activate through this one',
  file: "src/registry/project-registry.ts",
  find: 'content.runId === via.runId',
  replace: 'true',
  killedBy: [
...
export default anActivationGrantMatchesItsRun;

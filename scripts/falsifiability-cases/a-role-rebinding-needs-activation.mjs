/**
 * #833 — a re-registration that changes the repository role is refused rather than applying it.
 *
 ...
 */
const aRoleRebindingNeedsActivation = {
  id: 'a-role-rebinding-needs-activation',
  what: 'a re-registration that changes the repository role is refused rather than applying it',
  file: "src/registry/repository-registry.ts",
  find: 'input.repositoryRole !== existing.repositoryRole',
  replace: 'false',
  killedBy: [
...
export default aRoleRebindingNeedsActivation;

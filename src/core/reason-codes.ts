...
export const ReasonCode = {
  ...
  // (_CONFLICT). DIRECT_MUTATION_DENIED has no current producer; it remains in the stable
  // vocabulary because this branch has no evidence that the spelling was never published.
